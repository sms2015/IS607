-- Week 7 Assignment
--Week 7 assignment is due end of day on Tuesday October 14th. 
--A solution to the assignment will be posted on Wednesday October 15th.
...
--3. Populate the two tables with some sample data, using INSERT statements. Each table should contain 
...
--4. Provide samples of the different kinds of joins across the two tables. You should include one join that 
...
--5. Create an Entity-Relationship (ER) diagramthat shows the two tables that you created. 
