--Stacey Schwarcz
--Week 8 Quiz
--Week 8 quiz is due end of day on Sunday October 19th. A solution will be posted on Monday October 20th.
...
--(1) Create a single table that includes information for the CEO, the SVP of IOS Software, and the SVP, Chief 
--Financial Officer. Also include information for the direct reports of the two SVPs. [You should have a single 
--table with 8 rows].
...
 The [INSERT, UPDATE, DELETE] SQL statements needed to update the information to reflect the new CEO 
and COO as described in (3) above.
